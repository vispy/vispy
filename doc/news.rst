...
See the `Release Notes <https://github.com/vispy/vispy/blob/main/CHANGELOG.md>`_.
...
- **Presentation at SciPy 2015**, July 2015
- **GSoC 2015**: two GSoC students are currently working on VisPy under the PSF umbrella
