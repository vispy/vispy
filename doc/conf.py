...
latex_documents = [
  ('index', 'vispy.tex', u'vispy Documentation',
   u'vispy contributers', 'manual'),
]
...
man_pages = [
    ('index', 'vispy', u'vispy Documentation',
     [u'vispy contributers'], 1)
]
...
texinfo_documents = [
  ('index', 'vispy', u'vispy Documentation',
   u'vispy contributers', 'vispy', 'One line description of project.',
   'Miscellaneous'),
]
