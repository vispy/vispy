...
project = "VisPy"
copyright = "2013-{}, VisPy developers".format(date.today().year)
...
def _custom_edit_url(
    github_user, github_repo, github_version, doc_path, file_name, default_edit_page_url_template
):
...
html_context = {
    ...
    "github_version": "main",
    "doc_path": "doc",
    "edit_page_url_template": "{{ vispy_custom_edit_url(github_user, github_repo, github_version, doc_path, file_name, default_edit_page_url_template) }}",  # noqa
    "default_edit_page_url_template": "https://github.com/{github_user}/{github_repo}/edit/{github_version}/{doc_path}{file_name}",  # noqa
