...
using the methods and properties defined by vispy.scene.VisualNode. 
These classes are automatically generated by mixing vispy.scene.VisualNode with
the Visual classes found in vispy.visuals.

For developing custom visuals, it is recommended to subclass from
vispy.visuals.Visual rather than vispy.scene.VisualNode.
"""
import re
...
def create_visual_node(subclass):
    # Create a new subclass of VisualNode.
...
def generate_docstring(subclass, clsname):
    ...
    while i < len(lines):
        ...
        # (this is where the VisualNode inheritance description will be 
        # inserted)
