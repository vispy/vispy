...
class Visual(Entity):
    ...
    def draw(self, event=None):
        ...
        When using a scenegraph, *event* is generated automatically. Otherwise,
        it can be generated using SceneCanvas.draw_visual(), or by manually 
        instantiating a SceneDrawEvent and populating it with the required 
