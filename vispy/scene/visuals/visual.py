...
class Visual(Entity):
    ...
    def draw(self, event=None):
        ...
        1) In the absence of a scenegraph, *event* should be None and the 
           visual may use its .transform property to map its vertex 
           positions.
           
        2) When drawn from a scenegraph, *event* will be provided and will 
           indicate via its .render_transform property the correct 
