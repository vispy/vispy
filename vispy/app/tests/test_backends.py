...
from vispy.testing import requires_application, assert_in, run_tests_if_main, assert_raises
...
def test_template():
    ...
    for method in (a._vispy_process_events, a._vispy_run, a._vispy_quit, a._vispy_get_native_app):
    ...
    for method in (
        c._vispy_set_current,
        c._vispy_swap_buffers,
        c._vispy_close,
        c._vispy_update,
        c._vispy_get_size,
        c._vispy_get_position,
    ):
        assert_raises(NotImplementedError, method)
