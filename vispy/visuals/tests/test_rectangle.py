...
def test_rectangle_draw():
    ...
    with TestingCanvas() as c:
        rectpolygon = visuals.Rectangle(
            center=(50, 50, 0), height=40.0, width=80.0, color="red", parent=c.scene
        )
        ...
        rectpolygon = visuals.Rectangle(
            center=(50, 50, 0), height=40.0, width=80.0, radius=10.0, color="red", parent=c.scene
        )
...
def test_rectpolygon_draw():
    ...
    with TestingCanvas() as c:
        rectpolygon = visuals.Rectangle(
            center=(0.0, 0.0), height=20.0, width=20.0, radius=10.0, color="blue", parent=c.scene
        )
