...
def test_circle_draw():
    ...
    with TestingCanvas() as c:
        ellipse = visuals.Ellipse(center=(75, 35, 0), radius=20, color=(1, 0, 0, 1), parent=c.scene)
        assert_image_approved(c.render(), "visuals/circle1.png")

        ellipse.parent = None
        ellipse = visuals.Ellipse(
            center=(75, 35, 0),
            radius=20,
            color=(1, 0, 0, 1),
        ...
        ellipse.parent = None
        ellipse = visuals.Ellipse(
            center=(75, 35, 0), radius=20, border_color=(0, 1, 1, 1), parent=c.scene
        )
...
def test_ellipse_draw():
    ...
    with TestingCanvas() as c:
        ellipse = visuals.Ellipse(
            center=(0.0, 0.0), radius=(20, 15), color=(0, 0, 1, 1), parent=c.scene
        )
        ellipse.transform = transforms.STTransform(scale=(2.0, 3.0), translate=(50, 50))
        ...
        ellipse.parent = None
        ellipse = visuals.Ellipse(
            center=(0.0, 0.0), radius=(20, 15), border_color=(1, 0, 0, 1), parent=c.scene
        )
        ellipse.transform = transforms.STTransform(scale=(2.0, 3.0), translate=(50, 50))
...
def test_reactive_draw():
    ...
    with TestingCanvas() as c:
        ellipse = visuals.Ellipse(
            center=[75, 35, 0.0], radius=[20, 15], color="yellow", parent=c.scene
        )

        ellipse.center = [70, 40, 0.0]
