...
def test_regular_polygon_draw1():
    ...
    with TestingCanvas() as c:
        rpolygon = visuals.RegularPolygon(
            center=(0.0, 0.0), radius=0.4, sides=8, color=(1, 0, 0, 1), parent=c.scene
        )
        ...
        rpolygon.parent = None
        rpolygon = visuals.RegularPolygon(
            center=(0.0, 0.0), radius=0.4, sides=8, border_color=(0, 1, 1, 1), parent=c.scene
        )
...
def test_regular_polygon_draw2():
    ...
    with TestingCanvas() as c:
        rpolygon = visuals.RegularPolygon(
            center=(0.0, 0.0), radius=0.4, sides=8, color=(0, 0, 1, 1), parent=c.scene
        )
        ...
        rpolygon.parent = None
        rpolygon = visuals.RegularPolygon(
            center=(0.0, 0.0), radius=0.4, sides=8, border_color=(1, 0, 0, 1), parent=c.scene
        )
...
def test_reactive_draw():
    ...
    with TestingCanvas() as c:
        rpolygon = visuals.RegularPolygon(
            center=[50, 50, 0.0], radius=20, sides=8, color="yellow", parent=c.scene
        )
