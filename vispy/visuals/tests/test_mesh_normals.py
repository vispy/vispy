...
def test_mesh_normals():
    ...
    with TestingCanvas(size=size, bgcolor="k") as c:
        ...
        pytest.raises(
            ...
            rendered_without_normals,
            rendered_with_face_normals,
        )
...
def test_mesh_normals_length_array(primitive):
    ...
    with TestingCanvas(size=size, bgcolor="k") as c:
        ...
        normals_0_5 = scene.visuals.MeshNormals(
            meshdata, primitive=primitive, color=(1, 0, 0), length=lengths_0_5
        )
        normals_0_5.parent = mesh
        ...
        normals_1_0 = scene.visuals.MeshNormals(
            meshdata, primitive=primitive, color=(1, 0, 0), length=lengths_1_0
        )
        normals_1_0.parent = mesh
        ...
        normals_ramp = scene.visuals.MeshNormals(
            meshdata, primitive=primitive, color=(1, 0, 0), length=lengths_ramp
        )
...
def test_mesh_normals_length_scale():
    ...
    with TestingCanvas(size=size, bgcolor="k") as c:
        ...
        normals_scaled_up = scene.visuals.MeshNormals(
            meshdata, color=(1, 0, 0), length=length, length_scale=length_scale_up
        )
        ...
        normals_scaled_down = scene.visuals.MeshNormals(
            meshdata, color=(1, 0, 0), length=length, length_scale=length_scale_down
        )
