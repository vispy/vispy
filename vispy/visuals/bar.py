...
class BarVisual(MeshVisual):
    ...
    def __init__(self, data=None, height=None, bottom=None, width=0.8, color='w'):
        ...
        index, height, bottom = parsing_data(data, height, bottom)

        rr = calc_vertices(index, height, bottom, width)
...
def parsing_data(data, height, bottom):
    index = None
    ...
    return index, height, bottom


def calc_vertices(index, height, bottom, width):
