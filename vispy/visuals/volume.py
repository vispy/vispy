...
class VolumeVisual(Visual):
    ...
    def _create_texture(self, texture_format, emulate_texture, data):
        ...
        # FIXME: Handle texture properly
        if texture_format is not None:
            tex_cls = _GPUScaledTextured3D
        else:
            tex_cls = _CPUScaledTexture3D
