...
class Canvas(app.Canvas):
    def __init__(self):
        ...
        rect = visuals.RectangleVisual(
            center=(600, 200, 0),
            height=200.0,
            width=300.0,
            radius=[30.0, 30.0, 0.0, 0.0],
            color=(0.5, 0.5, 0.2, 1),
            border_color="white",
        )
        ...
        rpolygon = visuals.RegularPolygonVisual(
            center=(200.0, 600.0, 0),
            radius=160,
            color=(0.2, 0.8, 0.2, 1),
            border_color=(1, 1, 1, 1),
            sides=6,
    ...
    def on_timer(self, event):
        ...
        c = (
            0.3 * (0.5 + np.sin(event.elapsed * 2 + 0)),
            0.3 * (0.5 + np.sin(event.elapsed * 2 + np.pi * 2.0 / 3.0)),
            0.3 * (0.5 + np.sin(event.elapsed * 2 + np.pi * 4.0 / 3.0)),
        )
        polygon.color = c
