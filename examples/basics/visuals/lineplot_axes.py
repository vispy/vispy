...
pos[:, 1] = np.random.normal(size=N, scale=100, loc=canvas_size[1] / 2.)
...
class Canvas(app.Canvas):
    def __init__(self):
        ...
        self.axis_x = visuals.AxisVisual(extents=extents_x)
        self.axis_y = visuals.AxisVisual(extents=extents_y)
