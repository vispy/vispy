...
pos_xax = np.array(
    [[margin_x, canvas_size[1] - margin_y], [canvas_size[0] - margin_x, canvas_size[1] - margin_y]]
)
...
pos[:, 1] = np.clip(
    np.random.normal(size=N, scale=100, loc=canvas_size[1] / 2.0),
    margin_y,
    canvas_size[0] - margin_y,
)
