...
class VectorFieldVisual(visuals.Visual):
    ...
    def __init__(self, field, spacing=10, segments=3, seg_len=0.5, color=(1, 1, 1, 0.3)):
        ...
        self._field = gloo.Texture2D(
            field, format="rg", internalformat="rg32f", interpolation="linear"
        )
...
vfield = VectorField(
    field[..., :2], spacing=0.5, segments=30, seg_len=0.05, parent=view.scene, color=color
)
