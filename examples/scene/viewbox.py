...
line1 = scene.visuals.Line(
    pos=pos.copy(), color=color, method="gl", antialias=False, name="line1", parent=vb1.scene
)
line2 = scene.visuals.Line(
    pos=pos.copy(), color=color, method="gl", antialias=False, name="line1", parent=vb2.scene
)
...
box1 = scene.visuals.Line(
    pos=box, color=(0.7, 0, 0, 1), method="gl", name="unit box", parent=vb1.scene
)
box2 = scene.visuals.Line(
    pos=box, color=(0.7, 0, 0, 1), method="gl", name="unit box", parent=vb2.scene
)

box2 = scene.visuals.Line(
    pos=(box * 2 - 1), color=(0, 0.7, 0, 1), method="gl", name="nd box", parent=vb1.scene
)
box3 = scene.visuals.Line(
    pos=(box * 2 - 1), color=(0, 0.7, 0, 1), method="gl", name="nd box", parent=vb2.scene
)

# These boxes are only added to the 3D view.
box3 = scene.visuals.Line(
    pos=box + z, color=(1, 0, 0, 1), method="gl", name="unit box", parent=vb2.scene
)
box5 = scene.visuals.Line(
    pos=((box + z) * 2 - 1), color=(0, 1, 0, 1), method="gl", name="nd box", parent=vb2.scene
)
