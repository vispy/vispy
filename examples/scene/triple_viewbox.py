...
vb1 = grid.add_view(name='vb1', border_color='yellow', row=0, col=0, row_span=1, col_span=2)
# First ViewBox uses a 2D pan/zoom camera
vb1.camera = 'panzoom'

# Second ViewBox uses a 3D perspective camera
vb2 = grid.add_view(name='vb2', border_color='yellow', row=0, col=0, col_span=1)
...
vb3 = grid.add_view(name='vb3', border_color='yellow', row=0, col=1)
