...
unit_box1 = scene.visuals.Line(pos=box-z, color=(0.7, 0, 0, 1), name='unit box')
...
nd_box2 = scene.visuals.Line(pos=(box*2-1)+z, color=(0, 1, 0, 1), name='nd box')
vb1.add(unit_box1)
vb1.add(nd_box1)
vb2.add(unit_box1)
vb2.add(nd_box1)
